...
public class EchoTest extends TestContainer {
    ...
    public EchoTest() {
        setContextPath("/sample-echo-dart");
    ...
    public void startServer() throws DeploymentException {
        startServer(EchoEndpoint.class);
    }

    public static void main(String[] args) throws DeploymentException, IOException {
        final EchoTest echoTest = new EchoTest();
        echoTest.startServer();

        System.out.println();
        System.out.println("Sample is deployed on http://localhost:8025/index.html");
