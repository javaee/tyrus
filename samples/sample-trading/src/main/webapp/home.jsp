...
<html> 
    <script language="javascript" type="text/javascript"  >
        ...
        function init_buddies_ws() {
                ...
                buddiesWebSocket.onopen = function(evt) { onBuddiesWSOpen(evt) };
                buddiesWebSocket.onmessage = function(evt) { onBuddiesWSMessage(evt) };
                buddiesWebSocket.onerror = function(evt) { onBuddiesWSError(evt) };
        ...
        function init_quotes_ws() {
                ...
                quotesWebSocket.onopen = function(evt) { onQuotesWSOpen(evt) };
                quotesWebSocket.onmessage = function(evt) { onQuotesWSMessage(evt) };
                quotesWebSocket.onerror = function(evt) { onQuotesWSError(evt) };
        ...
        function init_twitter_ws() {
                ...
                twitterWebSocket.onopen = function(evt) { onTwitterWSOpen(evt) };
                twitterWebSocket.onmessage = function(evt) { onTwitterWSMessage(evt) };
                twitterWebSocket.onerror = function(evt) { onTwitterWSError(evt) };
        ...
        function popUp(evt,oi) {
            if (document.getElementById) {
                ...
                if (st == "visible" || st == "show") { 
                    ...
                    lv = mouseX(evt) - (ew/4); 
                    if (lv < 2) lv = 2; 
                    else if (lv + ew > wp) lv -= ew/2; lv += 'px';tv += 'px';  
    ...
    <body>
        ...
        <div id="output"></div>
        <table style="font:24px Bank Gothic,sans-serif; text-align: center; width: 100%;" border="0" cellpadding="2" cellspacing="1">
            <tr>
                <td>
