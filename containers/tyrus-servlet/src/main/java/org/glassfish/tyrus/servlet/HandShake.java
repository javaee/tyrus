...
//        }
        ...
        setExtensions(split(request.getHeader(SEC_WS_EXTENSIONS_HEADER)));
        secKey = SecKey.generateServerKey(new SecKey(request.getHeader(SEC_WS_KEY_HEADER)));
    }
    ...
    private void checkForHeader(HttpServletRequest req, String header, String validValue) {
    ...
    private void determineHostAndPort(HttpServletRequest req) {
        String header;
