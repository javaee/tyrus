...
public class DefaultServerConfigurationTest {
    ...
    public void testEndpoints(){
        ...
        configuration.endpoints(AnnotatedC.class, ProgrammaticConfA.class);

        Assert.assertEquals(1, configuration.getAnnotatedEndpointClasses(null).size());
        Assert.assertTrue(configuration.getAnnotatedEndpointClasses(null).contains(AnnotatedC.class));
    ...
    @WebSocketEndpoint(value = "/AC", configuration = javax.websocket.server.DefaultServerConfiguration.class)
