...
public class ErrorTest {
    ...
    public void testError() {
        ...
        server.start();
        try {
            final DefaultClientEndpointConfiguration.Builder builder = new DefaultClientEndpointConfiguration.Builder(new URI("ws://localhost:8025/websockets/tests/error"));
