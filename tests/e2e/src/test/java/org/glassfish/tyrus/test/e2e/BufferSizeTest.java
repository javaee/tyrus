...
public class BufferSizeTest {
    ...
    public void testText() {
        Server server = new Server(StringEndpoint.class);
    ...
    public void testBinary() {
        Server server = new Server(ByteArrayEndpoint.class);
    ...
    public void testReader() {
        Server server = new Server(ReaderEndpoint.class);
        ...
        try {
            ...
            }, clientConfiguration, new URI("ws://localhost:8025/websockets/tests/endpoint3"));
    ...
    public void testInputStream() {
        Server server = new Server(InputStreamEndpoint.class);
        ...
        try {
            ...
            }, clientConfiguration, new URI("ws://localhost:8025/websockets/tests/endpoint4"));
