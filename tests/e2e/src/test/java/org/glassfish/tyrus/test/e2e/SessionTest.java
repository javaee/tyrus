...
public class SessionTest {
    ...
    public void testSession() {
        Server server = new Server(org.glassfish.tyrus.test.e2e.bean.HttpSessionTestBean.class);
        server.start();
        try {
            messageLatch = new CountDownLatch(1);

            final DefaultClientEndpointConfiguration.Builder builder = new DefaultClientEndpointConfiguration.Builder("ws://localhost:8025/websockets/tests/session");
