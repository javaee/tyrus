 ...
 */
public class PartialBinaryTest {
    ...
    public void testBinaryByteArrayBean() {
        Server server = new Server(WSByteArrayPartialAndSessionServer.class);
    ...
    public void testBinaryByteBufferBean() {
        Server server = new Server(WSByteBufferPartialAndSessionServer.class);
