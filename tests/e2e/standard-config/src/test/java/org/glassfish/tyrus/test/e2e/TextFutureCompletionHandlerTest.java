...
public class TextFutureCompletionHandlerTest extends TestContainer {
    ...
    @Test
    public void testFastClient() throws DeploymentException {
        Server server = startServer(TextFutureCompletionHandlerEndpoint.class);
    ...
    @Test
    public void testSlowClient() throws DeploymentException {
        Server server = startServer(TextFutureCompletionHandlerEndpoint.class);
