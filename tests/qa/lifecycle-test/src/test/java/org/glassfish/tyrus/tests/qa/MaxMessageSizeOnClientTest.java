...
public class MaxMessageSizeOnClientTest extends AbstractLifeCycleTestBase {
    ...
    public void testMaxMessageSizeOnClient() throws DeploymentException, IOException {
        ...
        lifeCycle(MaxMessageSizeOnClient.Server.class, MaxMessageSizeOnClient.Client.class,
                  SessionController.SessionState.MESSAGE.getMessage(), testConf.getURI(), null);
    }
}
