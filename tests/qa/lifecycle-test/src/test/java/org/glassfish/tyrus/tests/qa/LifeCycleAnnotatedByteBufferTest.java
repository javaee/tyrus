 ...
 */
public class LifeCycleAnnotatedByteBufferTest extends AbstractLifeCycleTestBase {
    @Test
    public void testLifeCycleAnnotatedByteBuffer() throws DeploymentException, InterruptedException, IOException {
        ...
        lifeCycle(AnnotatedWholeMessageByteBufferSession.Server.class,
                  AnnotatedWholeMessageByteBufferSession.Client.class);
    }
}
