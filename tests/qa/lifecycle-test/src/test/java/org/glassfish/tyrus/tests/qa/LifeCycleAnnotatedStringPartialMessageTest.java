 ...
 */
public class LifeCycleAnnotatedStringPartialMessageTest extends AbstractLifeCycleTestBase {
    @Test
    public void testLifeCycleAnnotatedStringPartialMessage() throws DeploymentException, InterruptedException,
            IOException {
