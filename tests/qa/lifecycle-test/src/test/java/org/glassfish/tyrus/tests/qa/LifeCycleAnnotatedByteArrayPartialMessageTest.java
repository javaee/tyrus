 ...
 */
public class LifeCycleAnnotatedByteArrayPartialMessageTest extends AbstractLifeCycleTestBase {
    @Test
    public void testLifeCycleAnnotatedByteArrayPartialMessage() throws DeploymentException, InterruptedException,
            IOException {
