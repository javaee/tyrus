 ...
 */
public class ProgrammaticObjectInputStreamSessionConfig implements ServerApplicationConfiguration{
     @Override
    public Set<ServerEndpointConfiguration> getEndpointConfigurations(Set<Class<? extends Endpoint>> set) {
        ...
        ServerEndpointConfiguration config = ServerEndpointConfigurationBuilder.create(ProgrammaticObjectInputStreamSession.class, LifeCycleDeployment.LIFECYCLE_ENDPOINT_PATH).build();
