...
import org.glassfish.tyrus.tests.qa.handlers.WholeMessageHandler;
import org.glassfish.tyrus.tests.qa.tools.CommChannel;
import org.glassfish.tyrus.tests.qa.tools.SessionController;

abstract public class ProgrammaticEndpoint<T> extends Endpoint implements MessageHandler.Whole<T> {
