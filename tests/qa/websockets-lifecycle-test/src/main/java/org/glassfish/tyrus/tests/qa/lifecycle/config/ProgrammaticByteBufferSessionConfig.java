 ...
 */
public class ProgrammaticByteBufferSessionConfig implements ServerApplicationConfiguration {
    ...
    public Set<ServerEndpointConfiguration> getEndpointConfigurations(Set<Class<? extends Endpoint>> set) {
        ...
        ServerEndpointConfiguration config = ServerEndpointConfigurationBuilder.create(ProgrammaticByteBufferSession.class, LifeCycleDeployment.LIFECYCLE_ENDPOINT_PATH).build();
