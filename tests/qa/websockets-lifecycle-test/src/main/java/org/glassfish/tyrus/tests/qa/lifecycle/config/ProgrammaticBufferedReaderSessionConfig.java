 ...
 */
public class ProgrammaticBufferedReaderSessionConfig implements ServerApplicationConfiguration {
    ...
    public Set<ServerEndpointConfiguration> getEndpointConfigurations(Set<Class<? extends Endpoint>> set) {
        ...
        ServerEndpointConfiguration config = ServerEndpointConfigurationBuilder.create(ProgrammaticBufferedReaderSession.class, LifeCycleDeployment.LIFECYCLE_ENDPOINT_PATH).build();
