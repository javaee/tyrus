...
public class ServiceEndpoint {
    ...
    private void reset() {
        ...
        MaxSessionPerRemoteAddrApplicationConfig.openLatch =
                new CountDownLatch(MaxSessionPerRemoteAddrApplicationConfig.MAX_SESSIONS_PER_REMOTE_ADDR);
        MaxSessionPerRemoteAddrApplicationConfig.closeLatch =
                new CountDownLatch(MaxSessionPerRemoteAddrApplicationConfig.MAX_SESSIONS_PER_REMOTE_ADDR);
    }
}
