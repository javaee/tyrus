...
public class StreamingBinaryTest {
    ...
    public void testClient() {
        ...
        try {
            ...
            DefaultClientEndpointConfiguration.Builder builder = new DefaultClientEndpointConfiguration.Builder(new URI("ws://localhost:8025/websockets/tests/streamingbinary"));
