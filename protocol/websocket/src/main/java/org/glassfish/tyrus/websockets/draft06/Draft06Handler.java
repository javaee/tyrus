...
import org.glassfish.tyrus.websockets.Masker;
...
import org.glassfish.tyrus.websockets.frametypes.ContinuationFrameType;
...
public class Draft06Handler extends ProtocolHandler {
    ...
    @Override
    public DataFrame parse(final ByteBuffer buffer) {
