...
public class CoderWrapper<T> implements Decoder, Encoder {
     ...
     * @param originalClass {@link Class} of the coder.
     */
    public CoderWrapper(T instance, Class<?> type, Class<?> originalClass) {
    ...
    /**
     * Gets the original {@link Class} of the coder.
     *
     * @return original {@link Class} of the coder.
     */
