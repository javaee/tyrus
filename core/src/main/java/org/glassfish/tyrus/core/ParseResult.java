...
public class ParseResult /*implements Cacheable*/ {
    ...
    public static ParseResult create(boolean isComplete, ByteBuffer remainderBuffer) {
        ParseResult resultObject = new ParseResult();
    ...
    /**
     * Get the parsing remainder {@link ByteBuffer}. May not be null only in case, when parsing was completed, but some data
     * is still ready for parsing.
     *
     * @return the parsing remainder {@link ByteBuffer}. May not be null only in case, when parsing was completed, but some
